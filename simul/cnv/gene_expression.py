...
def _sample_gain_vector_high(n_genes: int, rng: Seed = 123) -> np.ndarray:
    ...
    # return truncated_cauchy_rvs(loc=4, scale=0.1, a=0, b=10, size=(n_genes,), rng=rng)
    return truncated_cauchy_rvs(loc=2, scale=0.1, a=0, b=10, size=(n_genes,), rng=rng)

def _sample_loss_vector_high(n_genes: int, rng: Seed = 123) -> np.ndarray:
    """Samples gain changes from a Cauchy distribution for highly expressed genes"""
    # return truncated_cauchy_rvs(loc=0.3, scale=0.1, a=0, b=10, size=(n_genes,), rng=rng)
    return truncated_cauchy_rvs(loc=0.3, scale=0.1, a=0, b=10, size=(n_genes,), rng=rng)
...
def change_expression(
    ...
    # gain_change = [2.3] * 5000
    # loss_change = [0.35] * 5000
    ...
    temp = expression * gains_effect * losses_effect
